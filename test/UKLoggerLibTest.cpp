...
TEST(UKLOGGER, LogToFile) {
    ...
    if (0 < lines.size()) {
        ...
        checkLogLine(lines.at(8), timer, "WARN", "Startup", "uk::log::UKLogger::setLogfileName(...)", 150,
...
TEST(UKLOGGER, LogToFileFailOpen) {
    ...
    if (0 < lines.size()) {
        ...
        checkLogLine(lines.at(4), timer, "FATAL", "Startup", "uk::log::UKLogger::setLogfileName(...)", 160,
...
TEST(UKLOGGER, LogToFileCannotDelete) {
    ...
    if (!output.empty()) {
        ...
        checkLogLine(lines.at(3), timer, "TRACE", "test class", "TestClass::testFunction(...)", 36,
                     "Enter int TestClass::testFunction(int) const");
        checkLogLine(lines.at(4), timer, "WARN", "Startup", "uk::log::UKLogger::setLogfileName(...)", 150,
                     std::string("Logfile ") + logFileName.u8string() + " exists. Deleting.");
        checkLogLine(lines.at(5), timer, "FATAL", "Startup", "uk::log::UKLogger::setLogfileName(...)", 152,
